...
wget https://github.com/Lockednet/LOCKEDWEB/raw/main/install/verweb > /dev/null 2>&1
...
echo ""
echo -e "LOCKED WEB" | figlet | boxes -d stone -p a0v0 | lolcat
...
echo ""
echo -e "OCKED WEB" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @LOCKED_SSH\033[1;36m" | lolcat
echo ""
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@LOCKED_SSH\033[0m" | lolcat
echo ""
